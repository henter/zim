...
trait RouteDependencyResolverTrait
{
    ...
    public function resolveMethodDependencies(array $parameters, ReflectionFunctionAbstract $reflector)
    {
        ...
        foreach ($reflector->getParameters() as $offset => $parameter) {
            ...
            if (!is_null($instance)) {
                $instanceCount++;
                array_splice($parameters, $offset, 0, [$instance]);
            } elseif (!isset($values[$offset - $instanceCount]) && $parameter->isDefaultValueAvailable()) {
                array_splice($parameters, $offset, 0, [$parameter->getDefaultValue()]);
            }
        }
